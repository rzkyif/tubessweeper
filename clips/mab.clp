...
(defrule put-chest-on-floor "" 
  ...
  =>
  (print "Monkey throws the " ?chest " off the " 
...
(defrule unlock-chest-with-key "" 
  ...
  =>
  (print "Monkey opens the " ?name " with the " ?key 
...
(defrule grab-object-from-ladder "" 
  ...
  =>
  (print "Monkey grabs the " ?name "." crlf)
...
(defrule drop-object ""  
  ...
  =>
  (print "Monkey drops the " ?name "." crlf)
  (modify ?monkey (holding blank))
...
(defrule walk-holding-nothing ""
  ...
  =>
  (print "Monkey walks to " ?place "." crlf)
...
(defrule walk-holding-object ""
  ...
  =>
  (print "Monkey walks to " ?place " holding the " ?obj "." crlf)
  (modify ?monkey (location ?place))
  (retract ?goal))
...
(defrule jump-onto-floor "" 
  ...
  =>
  (print "Monkey jumps off the " ?on " onto the floor." crlf)
...
(defrule climb-directly ""  
  ...
  ?monkey <- (monkey (location ?place) (on-top-of ?on) (holding blank))
  =>
  (print "Monkey climbs onto the " ?obj "." crlf)
...
(defrule satisfy-hunger ""
  ...
  ?thing <- (thing (name ?name))
  =>
  (print "Monkey eats the " ?name "." crlf)
  (modify ?monkey (holding blank))
  (retract ?goal ?thing))
